...
#     def show_edit_expense_dialog(e, expense_id, category, amount, date):
...
#                 if new_amount <= 0:
#                     raise ValueError("Amount must be positive")
#                 db.edit_expense(expense_id, new_category, new_amount, date)
...
#                 expense_id = f"{today}_{idx}"  # Synthetic ID
#                 expense_list.controls.append(
#                     ft.GestureDetector(
...
#                                                 icon_size=16,
#                                                 tooltip="Edit",
#                                                 on_click=lambda e, eid=expense_id, c=cat, a=amt, d=today: show_edit_expense_dialog(e, eid, c, a, d),
#                                             ),
#                                             ft.IconButton(
#                                                 ft.Icons.DELETE,
...
#                 expense_id = f"{selected_date.strftime('%Y-%m-%d')}_{idx}"  # Synthetic ID
#                 expense_list.controls.append(
#                     ft.GestureDetector(
#                         content=ft.Container(
#                             content=ft.Row(
...
#                                                 icon_size=16,
#                                                 tooltip="Edit",
#                                                 on_click=lambda e, eid=expense_id, c=cat, a=amt, d=selected_date.strftime("%Y-%m-%d"): show_edit_expense_dialog(e, eid, c, a, d),
#                                             ),
#                                             ft.IconButton(
#                                                 ft.Icons.DELETE,
#                                                 icon_color=ft.Colors.RED_500,
...
def expense_view(page: ft.Page, db: 'Database'):
    ...
    # Dialog for adding expense
    add_expense_dialog = ft.AlertDialog(
        title=ft.Text("Add Expense", color=ft.Colors.BLACK, size=18, weight=ft.FontWeight.BOLD, font_family="Roboto"),
        content=ft.Column([
            ft.TextField(
                label="Category",
                value="",
                ...
                [
                    ft.ElevatedButton(
                        ...
                        style=ft.ButtonStyle(
                            ...
                            text_style=ft.TextStyle(size=14, font_family="Roboto", weight=ft.FontWeight.W_500),
                        ),
                        on_click=lambda e: save_expense(e, page),
                        opacity=1.0,
    ...
    def save_expense(e, page):
        ...
        if not category or not amount_str:
            page.snack_bar = ft.SnackBar(
                content=ft.Text("Please enter both category and amount!", size=14, color=ft.Colors.WHITE, font_family="Roboto", weight=ft.FontWeight.W_500),
                bgcolor=ft.Colors.RED_700,
                padding=12,
        ...
        try:
            ...
            update_expense_display()
            page.snack_bar = ft.SnackBar(
                content=ft.Text(f"Expense '{category}: Rs{amount:.2f}' added!", size=14, color=ft.Colors.WHITE, font_family="Roboto", weight=ft.FontWeight.W_500),
                bgcolor=ft.Colors.GREEN_700,
                padding=12,
                margin=ft.margin.only(bottom=80),
                open=True,
            ...
            error_msg = str(ve) if str(ve) != "Amount must be positive" else "Please enter a valid positive amount!"
            page.snack_bar = ft.SnackBar(
                content=ft.Text(error_msg, size=14, color=ft.Colors.WHITE, font_family="Roboto", weight=ft.FontWeight.W_500),
                bgcolor=ft.Colors.RED_700,
                padding=12,
                margin=ft.margin.only(bottom=80),
                open=True,
    ...
    def show_edit_expense_dialog(e, expense_id, category, amount, date):
        ...
        def save_edit(e):
            ...
            try:
                ...
                update_expense_display()
                page.snack_bar = ft.SnackBar(
                    content=ft.Text(f"Expense '{new_category}: Rs{new_amount:.2f}' updated!", size=14, color=ft.Colors.WHITE, font_family="Roboto", weight=ft.FontWeight.W_500),
                    bgcolor=ft.Colors.GREEN_700,
                    padding=12,
                    margin=ft.margin.only(bottom=80),
                    open=True,
        ...
        edit_expense_dialog = ft.AlertDialog(
            title=ft.Text(f"Edit Expense: {category}", color=ft.Colors.BLACK, size=18, weight=ft.FontWeight.BOLD, font_family="Roboto"),
            content=ft.Column(
                [
                    edit_category_field,
                    edit_amount_field,
    ...
    def show_delete_expense_dialog(e, expense_id, category):
        def confirm_delete(e):
            try:
                ...
                update_expense_display()
                page.snack_bar = ft.SnackBar(
                    content=ft.Text(f"Expense '{category}' deleted!", size=14, color=ft.Colors.WHITE, font_family="Roboto", weight=ft.FontWeight.W_500),
                    bgcolor=ft.Colors.GREEN_700,
                    padding=12,
                    margin=ft.margin.only(bottom=80),
                    open=True,
                ...
                page.snack_bar = ft.SnackBar(
                    content=ft.Text(f"Error deleting expense: {str(ex)}", size=14, color=ft.Colors.WHITE, font_family="Roboto", weight=ft.FontWeight.W_500),
                    bgcolor=ft.Colors.RED_700,
                    padding=12,
                    margin=ft.margin.only(bottom=80),
                    open=True,
        ...
        delete_expense_dialog = ft.AlertDialog(
            title=ft.Text(f"Delete Expense: {category}", color=ft.Colors.BLACK, size=18, weight=ft.FontWeight.BOLD, font_family="Roboto"),
            content=ft.Text(f"Are you sure you want to delete '{category}'?", size=16, color=ft.Colors.GREY_800, font_family="Roboto"),
            actions=[
                ft.ElevatedButton(
                    "Delete",
    ...
    date_picker_button = ft.ElevatedButton(
        content=ft.Row(
            [
                ft.Icon(ft.Icons.CALENDAR_MONTH, color=ft.Colors.BLUE_700, size=20),
                ft.Text("Pick Date", color=ft.Colors.BLUE_700, weight=ft.FontWeight.BOLD, size=16, font_family="Roboto"),
            ],
            alignment=ft.MainAxisAlignment.CENTER,
            spacing=8,
        ),
                ...
                expense_list.controls.append(
                    ft.GestureDetector(
                        content=ft.Container(
                            content=ft.Row(
                                [
                                    ft.Text(f"{cat}", size=16, weight=ft.FontWeight.W_500, color=ft.Colors.BLACK, font_family="Roboto", max_lines=1),
                                    ft.Row(
                                        [
                                            ft.Text(f"Rs{amt:.2f}", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.RED_700, font_family="Roboto"),
                                            ft.IconButton(
                                                ft.Icons.EDIT,
            ...
            [
                ...
                ft.ElevatedButton(
                    content=ft.Row(
                        [
                            ft.Icon(ft.Icons.ADD, color=ft.Colors.GREEN_700, size=20),
                            ft.Text("Add Expense", color=ft.Colors.GREEN_700, weight=ft.FontWeight.BOLD, size=16, font_family="Roboto"),
                        ],
                        alignment=ft.MainAxisAlignment.CENTER,
                        spacing=8,
                    ),
